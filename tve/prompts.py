...
t = (
    "Вам дан набор терминов/фраз из патентной заявки, ваша задача - предложить {} синонимa или слова/фразы на английском языке, наиболее часто встречающиеся в технических/патентных документах совместно с каждым термином из набора и контекстно близких ему, постарайтесь предложить наиболее разнообразные варианты. Каждая предложенная фраза не должна быть длиннее 3х слов."
